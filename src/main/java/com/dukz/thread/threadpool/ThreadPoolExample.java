...
public class ThreadPoolExample {
    ...
    private void threadPoolExecutorTest4() throws Exception {
        ...
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(5, 5, 60L, TimeUnit.SECONDS,
    ...
    public static void main(String[] args) throws Exception {
        //      new ThreadPoolExample().threadPoolExecutorTest1();
        //      new ThreadPoolExample().threadPoolExecutorTest2();
        //      new ThreadPoolExample().threadPoolExecutorTest3();
             new ThreadPoolExample().threadPoolExecutorTest4();
        //      new ThreadPoolExample().threadPoolExecutorTest5();
        //      new ThreadPoolExample().threadPoolExecutorTest6();
        //      new ThreadPoolExample().threadPoolExecutorTest7();
        // new ThreadPoolExample().threadPoolExecutorTest8();
    }
}
